...
- **2026-07-16** — Claude Code 团队（1小时访谈）：给前沿模型的提示词要删例子、删 always/never 硬约束，每条指令必须 100% 为真；他们靠这个把系统提示词砍掉 80%。已采纳为写 skill 的新纪律 ([source](https://mrqb.space/?d=2026-07-16)) <!-- id:2026-07-16-171de726 -->
